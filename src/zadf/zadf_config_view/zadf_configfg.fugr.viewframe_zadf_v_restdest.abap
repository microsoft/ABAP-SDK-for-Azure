*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZADF_V_RESTDEST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZADF_V_RESTDEST     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZADF_V_RESTDEST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZADF_V_RESTDEST_EXTRACT
TOTAL = ZADF_V_RESTDEST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZADF_V_RESTDEST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZADF_V_RESTDEST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADF_V_RESTDEST_EXTRACT
TOTAL = ZADF_V_RESTDEST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZADF_V_RESTDEST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZADF_V_RESTDEST'
...
TOTAL = ZADF_V_RESTDEST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZADF_V_RESTDEST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZADF_V_RESTDEST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZADF_V_RESTDEST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZADF_V_RESTDEST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADF_V_RESTDEST_EXTRACT
TOTAL = ZADF_V_RESTDEST_TOTAL
