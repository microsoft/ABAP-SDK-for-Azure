*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZREST_V_CONF_MIS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZREST_V_CONF_MIS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZREST_V_CONF_MIS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZREST_V_CONF_MIS_EXTRACT
TOTAL = ZREST_V_CONF_MIS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZREST_V_CONF_MIS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZREST_V_CONF_MIS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZREST_V_CONF_MIS_EXTRACT
TOTAL = ZREST_V_CONF_MIS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZREST_V_CONF_MIS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZREST_V_CONF_MIS'
...
TOTAL = ZREST_V_CONF_MIS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZREST_V_CONF_MIS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZREST_V_CONF_MIS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZREST_V_CONF_MIS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZREST_V_CONF_MIS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZREST_V_CONF_MIS_EXTRACT
TOTAL = ZREST_V_CONF_MIS_TOTAL
