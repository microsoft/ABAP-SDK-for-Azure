*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZADF_V_MI_CONFIG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZADF_V_MI_CONFIG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZADF_V_MI_CONFIG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZADF_V_MI_CONFIG_EXTRACT
TOTAL = ZADF_V_MI_CONFIG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZADF_V_MI_CONFIG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZADF_V_MI_CONFIG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADF_V_MI_CONFIG_EXTRACT
TOTAL = ZADF_V_MI_CONFIG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZADF_V_MI_CONFIG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZADF_V_MI_CONFIG'
...
TOTAL = ZADF_V_MI_CONFIG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZADF_V_MI_CONFIG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZADF_V_MI_CONFIG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZADF_V_MI_CONFIG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZADF_V_MI_CONFIG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADF_V_MI_CONFIG_EXTRACT
TOTAL = ZADF_V_MI_CONFIG_TOTAL
