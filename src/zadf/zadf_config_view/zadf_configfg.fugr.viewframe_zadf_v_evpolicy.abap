*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZADF_V_EVPOLICY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZADF_V_EVPOLICY     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZADF_V_EVPOLICY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZADF_V_EVPOLICY_EXTRACT
TOTAL = ZADF_V_EVPOLICY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZADF_V_EVPOLICY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZADF_V_EVPOLICY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADF_V_EVPOLICY_EXTRACT
TOTAL = ZADF_V_EVPOLICY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZADF_V_EVPOLICY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZADF_V_EVPOLICY'
...
TOTAL = ZADF_V_EVPOLICY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZADF_V_EVPOLICY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZADF_V_EVPOLICY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZADF_V_EVPOLICY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZADF_V_EVPOLICY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADF_V_EVPOLICY_EXTRACT
TOTAL = ZADF_V_EVPOLICY_TOTAL
